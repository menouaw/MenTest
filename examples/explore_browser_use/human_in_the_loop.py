...
@controller.action('Ask human for help with a question', domains=['https://*.orangehrmlive.com'])   # pass allowed_domains= or page_filter= to limit actions to certain pages
